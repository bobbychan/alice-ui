...
import { forwardRefType, RenderProps, StyleProps } from '../_utils/utils';
...
export function useCollectionDocument<T extends object, C extends BaseCollection<T>>(
  initialCollection?: C,
): CollectionDocumentResult<T, C> {
  // The document instance is mutable, and should never change between renders.
  // useSyncExternalStore is used to subscribe to updates, which vends immutable Collection objects.
  let document = useMemo(
...
export function useCollectionPortal<T extends object, C extends BaseCollection<T>>(
  props: CollectionProps<T>,
  document: Document<T, C>,
): ReactNode {
...
export function useShallowRender<T extends Element>(
  Element: string,
